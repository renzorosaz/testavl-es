...
class MovieModel {
  ...
  factory MovieModel.fromJson(Map<String, dynamic> json) => MovieModel(
        ...
        id: json["id"] ?? json["id"],
        originalLanguage:
            json["original_language"] ?? json["original_language"],
        originalTitle: json["original_title"] ?? json["original_title"],
        overview: json["overview"] ?? json["overview"],
        popularity: json["popularity"] ?? json["popularity"].toDouble(),
        ...
        voteAverage: json["vote_average"] ?? json["vote_average"].toDouble(),
